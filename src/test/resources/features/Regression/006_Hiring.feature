Feature: Feature to Test Settings Hiring functionality
  ...
  Scenario Outline: Hiring
    ...
    Examples:
      ...
      | California | Closer 1 | ca.closer@gmail.com | (888) 123-4567 | California  | Cal Office | Testing Team | Testing Closer |           |                             | California  Manager 1 |      | California Manager 1 | 40               | Shift based on Location | 2.6           |                      | 100              | Per KW                  |                      |                             |                  |                   |               |                      |                  |                         |                    |                      |                   |                       | 200             | Per Sale            | 100               | Per Sale              |                 |                     | None            |                    |              |             | 01/07/2024                 |                          | 12/31/2025      | Checked     | Test Sig |
