Feature: Feature to Test Settings Hiring functionality
  ...
  Scenario Outline: Hiring
    ...
    Examples:
      ...
      | California | Manager 1 | ca.manager@gmail.com | (777) 123-4567 | California  | Cal Office | Testing Team | Testing Manager | Checked   | Checked                     |         |      | CSO Test  | 40               | Fixed             | 2.5           |                      | 0                | Per KW                  | 0                    | Per Sale                    | 50               | Fixed             | 2.7           |                      | 100              | Per KW                  | Per Sale           | 0                    | 90                | %                     | 300             | Per Sale            | 25                | Per KW                | 100             | Per Sale            | None            |                    |              |             | 01/01/2024                 |                          | 12/31/2025      | Checked     | Test Sig |
